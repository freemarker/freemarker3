 ...
 * it defaulted <tt>/</tt>, that is to loading from the webapp root directory.</i>
 * Note also that you can specify multiple locations, by separating the individual
 * locations with a comma.</li>
 * 
 ...
 * @version $Id: FreemarkerServlet.java,v 1.82 2005/06/13 20:52:56 szegedia Exp $
 */
...
public class FreemarkerServlet extends HttpServlet
{
     ...
     * specified, {@link ObjectWrapper#SIMPLE_WRAPPER} is used.In
