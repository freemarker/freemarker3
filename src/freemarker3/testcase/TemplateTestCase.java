...
import freemarker3.testcase.models.*;
...
//            dataModel.put("list", Arrays.asList("list-0", "list-1", "list-2"));
            ...
            dataModel.put("obj", new freemarker3.testcase.models.BeanTestClass());
            dataModel.put("resourceBundle", new ResourceBundleWrapper(ResourceBundle.getBundle("freemarker3.testcase.models.BeansTestResources")));
            dataModel.put("date", new GregorianCalendar(1974, 10, 14).getTime());
        }

        else if (testName.equals("compress")) {
            dataModel.put("compression", new freemarker3.template.utility.StandardCompress());
        }
            ...
            dataModel.put("htmlEscape", new freemarker3.template.utility.HtmlEscape());
